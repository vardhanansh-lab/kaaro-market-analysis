...
## 4. What the interviews actually told us

Market sizing tells you the opportunity is real; it doesn't tell you what to build. That came from 60+ conversations with users and service providers. A few recurring findings from each side:

**From users (20+ interviews):**
- Most people said they'd stick with a WhatsApp electrician they'd used once before, purely because re-discovering a new one felt riskier than the small chance of a bad repeat job
- Price wasn't the top complaint as much as *unpredictability* — the same job quoted differently depending on who picked up the phone
- Several mentioned they'd happily pay a small premium for someone with a verified badge, especially for in-home services like cleaning or childcare
- Almost nobody trusted online reviews for local services the way they trust a neighbour's recommendation

**From service providers (40+ interviews):**
- Many said their biggest cost wasn't marketing — it was the unpaid time spent traveling to jobs that fell through after a call
- Providers were skeptical of "marketplace" apps in general, since past experience with aggregators meant delayed payouts or unclear fee cuts
- A recurring ask was more predictable, steady work over occasional high-paying jobs — income stability mattered more than peak pricing
- Several described losing repeat customers simply because they had no way to remind or re-engage them after the first job
...
*Sources: Redseer Strategy Consultants, McKinsey, TechCrunch (2026 market estimates); Tracxn and PitchBook (competitor landscape, 2026); primary research — 60+ user and provider interviews conducted directly, plus Bareilly pilot data.*
